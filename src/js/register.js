define(function(require, exports, module) {
    ...
    var timer   = null,    //验证码定时器
        ...
        urlObj  = {        //接口URL
            ...
            register : baseApiURL + 'user/register/mobile/doRegister', //注册提交
    ...
    function getImgCode(ele){
        var _data = {
                type : 1  //类型,1:注册,2:忘记密码,3:密码登录,4:短信登录
            };
    ...
    // 图形验证码验证
    function checkImageCode(ele,type){
        var _v = $(ele).val();
    ...
    .on('tap','#getCode',function(){
    	...
    	var _mobile = $('#register [name="mobile"]').val();
                    ...
                    if(data && data.code == 200){
                        ...
                        // if(data.data.sessionId>3){
                            AoDialog.prompt({
                                    ...
                                    checkImageCode('input[name="imgcoder"]',1) //类型,1:注册,2:忘记密码,3:密码登录,4:短信登录
                                },function(){
                                    console.log('prompt 关闭')
                            });
                            getImgCode('#imgCoder'); //获取图形验证码
                        // }else{
                        //     AoDialog.alert(data.msg || '注册失败，请重试');
                        // }; 
                    }
				},
				error: function(data){
